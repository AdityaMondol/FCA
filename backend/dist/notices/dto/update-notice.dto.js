...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(5000, { message: 'Body must not exceed 5000 characters' }),
    (0, class_transformer_1.Transform)(({ value }) => value?.trim()),
    __metadata("design:type", String)
], UpdateNoticeDto.prototype, "body", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['bn', 'en'], { message: 'Language must be either "bn" or "en"' }),
    __metadata("design:type", String)
], UpdateNoticeDto.prototype, "language", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
...
], UpdateNoticeDto.prototype, "isPublished", void 0);
