...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(6, { message: 'Password confirmation must be at least 6 characters long' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['student', 'guardian', 'teacher'], {
...
__decorate([
    ...
    (0, class_validator_1.IsString)({ message: 'Teacher code is required for teacher registration' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "teacherCode", void 0);
